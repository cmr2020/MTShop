    ...
    public partial class initCategory : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoleId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    RoleTitle = table.Column<string>(maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPurchaseInformations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_UserPurchaseInformations_Id",
                        column: x => x.Id,
                        principalTable: "UserPurchaseInformations",
                        principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Products_Categories_SubGroup",
                table: "Products",
                column: "SubGroup",
                principalTable: "Categories",
                principalColumn: "Id",
